...
| Échange Julie B. (échange de taille) | échange réel, client anonymisé |
...
## 8. Ailleurs que sur le site

- `campagne-cold-email-employe-sav/sequence-v1.md` annonce encore « [2] boutiques »
  dans l'email de rupture. À aligner sur 15, sinon incohérence avec la page.
